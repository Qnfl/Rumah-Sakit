        ...
        <table class="table table-striped table-hover tabel-sm">
          ...
          ?>
            <tr>
              ...
              <td><?= $data['jk']; ?></td>
              <td><?= $data['alamat']; ?></td>
              <td><a href="editpasien.php?edit=<?= $data['idPasien']; ?>" class="btn btn-warning btn-sm">Edit </a><a href="koneksi.php?idPasien=<?= $data['idPasien']; ?>" class="btn btn-danger btn-sm">Hapus</a></td>
            </tr>
          <?php } ?>
        </table>
      </div>
